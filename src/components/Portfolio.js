  ...
  const openPopupboxChatApp = () => {
    const content = (
      <>
        ...
        <b>GitHub:</b>{" "}
        <a className="hyper-link" onClick={() => window.open("https://github.com/ko1219/chat-app")}>
          https://github.com/ko1219/chat-app
        </a>
      </>
    );
  ...
  const openPopupboxChoiceClass = () => {
    const content = (
      <>
        ...
        <b>GitHub:</b>{" "}
        <a className="hyper-link" onClick={() => window.open("https://github.com/ko1219/choice-class")}>
          https://github.com/ko1219/choice-class
        </a>
      </>
    );
    PopupboxManager.open({ content });
  ...
  const openPopupboxFurimaApp = () => {
    const content = (
      <>
        ...
        <p>free market app</p>
        <b>Demo:</b>{" "}
        <a className="hyper-link" onClick={() => window.open("https://furima-34865.herokuapp.com/", "_blank")}>
          https://furima-34865.herokuapp.com/
        </a>
        <br />
        <b>GitHub:</b>{" "}
        <a className="hyper-link" onClick={() => window.open("https://github.com/ko1219/furima-34865")}>
          https://github.com/ko1219/furima-34865
        </a>
      </>
    );
    PopupboxManager.open({ content });
  ...
  const openPopupboxProtoSpace = () => {
    const content = (
      <>
        ...
        <p>Share a prototype app</p>
        <b>Demo:</b>{" "}
        <a className="hyper-link" onClick={() => window.open("https://protospace-34865.herokuapp.com/", "_blank")}>
          https://protospace-34865.herokuapp.com/
        </a>
        <br />
        <b>GitHub:</b>{" "}
        <a className="hyper-link" onClick={() => window.open("https://github.com/ko1219/protospace-34865")}>
          https://github.com/ko1219/protospace-34865
        </a>
      </>
    );
    PopupboxManager.open({ content });
